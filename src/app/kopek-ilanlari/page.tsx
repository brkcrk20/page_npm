...
const initialMockReviews = [
    ...
    },
    {
      ...
      comment: "Aradığım Golden Retriever'ı buradan buldum. Sitedeki bilgiler çok yardımcı oldu.",
      date: "4 gün önce"
    }
  ];
    ...
    <div className="container mx-auto py-8">
       <div className="grid grid-cols-1 md:grid-cols-[300px_1fr] gap-8">
        ...
        <main className="col-span-1">
            ...
            {/* Popular Listings */}
            <div className="mt-12">
                <h2 className="text-2xl font-bold mb-4">Popüler Köpek İlanları</h2>
            ...
            <div className="mt-16">
                <div className="flex items-center gap-2 mb-6">
                    ...
                    <h2 className="text-2xl font-bold">Köpek Sahiplenme Hakkında Yorumlar</h2>
                </div>
