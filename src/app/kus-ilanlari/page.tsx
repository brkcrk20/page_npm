    ...
    <div className="container mx-auto py-8">
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        <aside className="lg:col-span-1">
           <BreedPageSidebar 
            categoryName={category?.title || 'Kuş İlanları'}
        ...
        <main className="lg:col-span-3">
            ...
            <span className="font-semibold text-foreground">Kuş İlanları</span>
            </div>

            <p className="text-sm text-muted-foreground mb-6">
            <span className='font-bold text-primary'>Kuş İlanları</span> kategorisinde <span className='font-bold text-foreground'>{filteredPets.length}</span> ilan bulundu.
            </p>
