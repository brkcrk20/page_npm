...
import { handleImproveDescription, handleSuggestBreeds } from '@/app/ilan-ver/actions';
...
export function CreateMatingListingForm() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="font-headline">Eşleştirme İlanı Detayları</CardTitle>
        <CardDescription>Dostunuz için bir eş aradığınızı belirtin.</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea placeholder="Dostunuzun özelliklerini, beklentilerinizi anlatın..." className="min-h-[150px]" {...field} />
                      </FormControl>
                      <FormMessage />
            ...
            <div className="flex justify-end">
              <Button type="submit" size="lg">Eşleştirme İlanı Oluştur</Button>
            </div>
          </form>
        </Form>
      </CardContent>
