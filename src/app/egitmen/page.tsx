...
export default function TrainerPage() {
  ...
  const heroImage = PlaceHolderImages.find(img => img.id === 'trainer-hero') ?? { imageUrl: 'https://picsum.photos/seed/trainer-hero/1200/400', description: 'Dog being trained', imageHint: 'dog training' };
      ...
      <section className="relative w-full h-64 bg-primary/10">
        ...
        <div className="relative container mx-auto h-full flex flex-col items-start justify-end text-white pb-12">
          <h1 className="text-4xl md:text-5xl font-headline font-bold tracking-tight">
            Profesyonel Evcil Hayvan Eğitmenleri
          </h1>
          <p className="mt-2 max-w-2xl text-lg text-primary-foreground/80">
            Dostunuzun potansiyelini ortaya çıkaracak en iyi eğitmenler.
          </p>
        </div>
      </section>
